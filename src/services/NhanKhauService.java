...
public class NhanKhauService {
    ...
    public static boolean update(NhanKhauModel nhanKhauModel) throws ClassNotFoundException, SQLException {
        Connection connection = MysqlConnection.getMysqlConnection();
    ...
    public static List<NhanKhauModel> getListNhanKhau(int IDHoKhau) throws ClassNotFoundException, SQLException {
    ...
    public static List<NhanKhauModel> getListChuHo() throws ClassNotFoundException, SQLException {
        List<NhanKhauModel> list = new ArrayList<>();

        Connection connection = MysqlConnection.getMysqlConnection();
        String query = "SELECT * FROM nhankhau WHERE QHvsChuHo = 'Chủ hộ' AND IDHoKhau IN (SELECT IDHoKhau FROM hokhau WHERE NgayDi = '0001-01-01')";
        PreparedStatement preparedStatement = connection.prepareStatement(query);
        ResultSet rs = preparedStatement.executeQuery();
        while (rs.next()) {
            NhanKhauModel nhanKhauModel = new NhanKhauModel();
    ...
    public static List<NhanKhauModel> getListChuHoChuaDongDu(int IDKhoanThu) throws ClassNotFoundException, SQLException {
        List<NhanKhauModel> list = new ArrayList<>();

        Connection connection = MysqlConnection.getMysqlConnection();
        String query = "SELECT * FROM nhankhau WHERE QHvsChuHo = 'Chủ hộ' AND IDHoKhau NOT IN (SELECT IDHoKhau FROM thuphi WHERE IDKhoanThu = ? AND TienDaDong >= SoTienPhaiDong) AND IDHoKhau IN (SELECT IDHoKhau FROM hokhau WHERE NgayDi = '0001-01-01')";
        PreparedStatement preparedStatement = connection.prepareStatement(query);
