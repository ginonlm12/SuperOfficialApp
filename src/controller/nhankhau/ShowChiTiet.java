...
public class ShowChiTiet {
    ...
    public void setNhanKhauModel(NhanKhauModel nhanKhauModel) throws ClassNotFoundException, SQLException {
        ShowChiTiet.nhanKhauModel = nhanKhauModel;
...
//		tfSoCMND.setText(nhanKhauModel.getCmnd());maNhanKhau = nhanKhauModel.getId();
	...
	private void initializeLogic() throws SQLException, ClassNotFoundException {
		...
		try {
            nhanKhauModel = NhanKhauService.loadDatafromID(IDNhanKhau);
		...
		if(nhanKhauModel != null) {
            ...
            tfSoPhong.setText(String.valueOf(NhanKhauService.getSoPhong(nhanKhauModel.getIDHoKhau())));
		}
	}
}
