...
public class KhoanThuModel {
	...
	public KhoanThuModel(int IDKhoanThu, String TenKT, String NgayBatDau, String NgayKetThuc,
			double TrongSoDienTich, double TrongSoSTV, double HangSo, String LoaiKhoanThu) {
